 ...
 */
public class ApiLogin extends AsyncTask<HashMap<String, String>, String, JSONObject> {
...
//  3번 파라미터는 protected void onPostExecute(3 result)  으로 들어간다  3번은 doInBackground 의 return 형태이기도 해야 한다
    ...
    public ApiLogin(Context context, InterfaceAsyncResponse delegate)
    {
    ...
    protected JSONObject doInBackground(HashMap<String, String>... params) {
        ...
        try {
            result = WebApi.login(context, getData);
